...
First install all dependencies for Gadgetron. The following will install everything you need:
    ...
    sudo apt-get install libhdf5-serial-dev cmake git-core libboost-all-dev build-essential \
    libfftw3-dev h5utils hdf5-tools python-dev python-numpy liblapack-dev libxml2-dev \
    libxslt-dev libarmadillo-dev libace-dev python-h5py python-matplotlib \
    python-libxml2 gcc-multilib python-psutil libgtest-dev nvidia-cuda-toolkit 
